<h1>
  ...
  <?php echo anchor('admin/kursi/add','<button class="btn btn-success">Tambah Data</button>');?>
</span>
</h1>
		...
		<table class="table table-bordered" width="100%" border="1" cellpadding="5" cellspacing="5">
			...
			foreach ($hasil as $key => $list)
			{
				...
				<tr>
					...
					<td align="center">
						<?php echo anchor('admin/kursi/edit/'.$list['KURSI_ID'],'<button class="btn btn-primary">EDIT</button>','title="edit"');?>
						&nbsp;&nbsp;&nbsp;
						<?php
						$attr_del = array('onclick' => 'return confirmDel();','title' => 'delete');
						echo anchor('admin/kursi/delete/'.$list['KURSI_ID'],'<button class="btn btn-danger">DELETE</button>',$attr_del); 
						?>
